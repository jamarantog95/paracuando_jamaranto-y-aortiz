...
module.exports = (sequelize, DataTypes) => {
   ...
   Users.init({
      ...
      timestamps: true,
      scopes: {
         view_public: { attributes: ['id', 'first_name', 'last_name', 'email', 'username', 'email_verified', 'country_id', 'code_phone', 'phone', 'image_url'] },
         view_same_user: { attributes: ['id', 'first_name', 'last_name', 'email', 'username', 'email_verified', 'country_id', 'code_phone', 'phone', 'image_url'] },
