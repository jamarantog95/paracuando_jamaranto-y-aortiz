...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    try {
      const adminUser = await usersService.findUserByEmailOr404('jc_amg@academlo.com')
      const adminUser2 = await usersService.findUserByEmailOr404('jc_rod@academlo.com')
