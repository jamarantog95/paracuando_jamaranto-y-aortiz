...
class UsersService {
  ...
  //    let admin = await models.Roles.findOne({
  //       where: {
  //          name: 'admin'
  //       },
  //    })
  //    if (!admin)
  //       throw new CustomError('Not found Role', 404, 'Not Found');
  ...
  //    if (!profile)
  //       throw CustomError('User does not have permission', 403, 'Permission denied');
  // }
}
